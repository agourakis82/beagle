...
OUT="${OUT:-${ROOT}/.artifacts/darwin-hpc/repo-aware-workflow-smoke}"
API_TOKEN="${BEAGLE_API_TOKEN:?BEAGLE_API_TOKEN is required}"
WORKSPACE_ID="${WORKSPACE_ID:-b125-$(date +%m%d%H%M%S)}"
...
echo "[OK] repo-aware workflow smoke artifacts written to ${OUT}"
