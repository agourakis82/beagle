...
OUT="${OUT:-${ROOT}/.artifacts/darwin-hpc/operator-real-workflow-smoke}"
API_TOKEN="${BEAGLE_API_TOKEN:?BEAGLE_API_TOKEN is required}"
WORKSPACE_ID="${WORKSPACE_ID:-b126-$(date +%m%d%H%M%S)}"
...
echo "[OK] operator-real workflow smoke artifacts written to ${OUT}"
