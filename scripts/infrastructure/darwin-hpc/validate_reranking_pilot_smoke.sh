...
jq -e '
  ...
  .expected_general_reranker == "voyage-rerank-2.5" and
  .expected_sovereign_reranker == "bge-reranker-v2-m3" and
...
jq -e '
  ...
  .bounded_top_k == 5 and
  .general_candidate_id == "voyage-rerank-2.5" and
  .sovereign_candidate_id == "bge-reranker-v2-m3" and
  any(.candidates[]; .candidate_id == "voyage-rerank-2.5" and .runtime_state == "pilot-active" and .route_scope == "general") and
  any(.candidates[]; .candidate_id == "bge-reranker-v2-m3" and .runtime_state == "pilot-active" and .route_scope == "sovereign")
...
jq -e '
  ...
  .sparse_backend == "local-lexical" and
  .reranker_backend == "bge-reranker-v2-m3" and
  .reranker_runtime_state == "pilot-active" and
  .reranking_applied == true and
  (.hits | length) >= 1 and
  all(.hits[]; .point.payload.workstream_id == "beagle-darwin-hpc-governance") and
...
jq -e '
  ...
  .general.reranker_backend == "voyage-rerank-2.5" and
  .general.reranking_applied == true and
  .sovereign.query_type == "sovereign" and
  .sovereign.reranker_backend == "bge-reranker-v2-m3" and
...
jq -e '
  ...
  .sparse_backend == "local-lexical" and
  .general_reranker_backend == "voyage-rerank-2.5" and
  .sovereign_reranker_backend == "bge-reranker-v2-m3" and
