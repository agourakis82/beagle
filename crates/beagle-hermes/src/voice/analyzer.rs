...
impl VoiceAnalyzer {
    ...
    pub fn voice_similarity(&self, profile: &VoiceProfile, candidate_text: &str) -> f64 {
        ...
        let vocab_sim =
            self.compute_vocab_overlap(&profile.vocabulary_fingerprint, &candidate_vocab);
    ...
    fn test_voice_analyzer() {
        ...
        analyzer.add_document(
            "This is a test document. It contains multiple sentences with repeated words. \
             ...
             Some words appear multiple times in this text."
                .to_string(),
        );
    ...
    fn test_voice_similarity() {
        ...
        analyzer.add_document(
            "The results demonstrate significant improvements in the methodology. \
             ...
             The methodology demonstrates substantial enhancements."
                .to_string(),
        );
