    ...
    pub async fn refine(
        ...
        if !transition_issues.is_empty() {
            ...
            refinement_instructions
                .push_str("Action: Add appropriate transition words or phrases.\n\n");
        }
        ...
        if !claim_issues.is_empty() {
            ...
            refinement_instructions
                .push_str("Action: Add citations [X] to support these claims.\n\n");
        }
        ...
        if !reference_issues.is_empty() {
            ...
            refinement_instructions
                .push_str("Action: Clarify pronoun references or replace with explicit nouns.\n\n");
        }
...
REFINED DRAFT:
"#,
            original_context, draft, refinement_instructions
        );
        ...
        let request = CompletionRequest {
            ...
            system: Some(
                "You are an expert scientific editor specializing in academic writing refinement."
                    .to_string(),
            ),
        };
    ...
    pub async fn refine_iteratively(
        ...
        for iteration in 1..=self.max_iterations {
            ...
            if issues.is_empty() {
                info!(
                    "Draft meets quality standards after {} iterations",
                    iteration
                );
                break;
            }
