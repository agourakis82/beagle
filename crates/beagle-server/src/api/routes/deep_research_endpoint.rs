...
pub async fn deep_research(
    ...
    let engine = state.deep_research_engine()
        .ok_or((StatusCode::SERVICE_UNAVAILABLE, "Deep Research not available".to_string()))?;
    
    let result = engine.deep_research(&req.query).await
