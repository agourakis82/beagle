...
async fn main() -> anyhow::Result<()> {
    ...
    println!("✅ {} hipóteses geradas em superposição:", hypothesis_set.hypotheses.len());
    ...
    interference.apply_multiple_evidences(&mut hypothesis_set, evidences).await?;
    ...
    let final_answer = measurement.collapse(hypothesis_set, CollapseStrategy::CriticGuided).await?;
