...
export SSH_AUTHORIZED_KEYS_SECRET_NAME PROJECT_REPO_SECRET_NAME PROJECT_REPO_SEED_MODE PROJECT_WORKSPACE_ROOT PROJECT_TMUX_SESSION PROJECT_AUTO_TMUX_ATTACH WORKSPACE_NODE_PREFERENCE WORKSPACE_NODE_SELECTOR WORKSPACE_EXTRA_TOLERATIONS REPO_SEED_IMAGE DOLLAR
