...
- **All apps prefer the same public mobile gateway** — `https://beagle.chiuratto.ai`. Private fallback paths still work for dev via `http://sounio-cockpit.tail21cbc4.ts.net`, `http://100.107.208.198`, or the in-cluster service DNS.
