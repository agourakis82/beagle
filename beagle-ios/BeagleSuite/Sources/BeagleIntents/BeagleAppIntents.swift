...
public struct ActivateHabitatIntent: AppIntent {
    ...
    public func perform() async throws -> some IntentResult & ProvidesDialog {
        // TODO: POST /api/projects/{slug}/go-work-now/actions/activate-habitat
        let dialog = IntentDialog(stringLiteral: "Activating habitat for \(project.slug)")
...
public struct StandbyHabitatIntent: AppIntent {
    ...
    public func perform() async throws -> some IntentResult & ProvidesDialog {
        // TODO: POST /api/projects/{slug}/go-work-now/actions/standby-habitat
