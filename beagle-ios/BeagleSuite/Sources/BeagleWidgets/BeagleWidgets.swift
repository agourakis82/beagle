...
public struct AgentSessionAttributes: ActivityAttributes {
    public struct ContentState: Codable, Hashable {
        public var status: String           // "running" | "thinking" | "awaiting-input" | "completed"
    ...
    public var agentKind: String     // "claude-code" | "codex" | ...
