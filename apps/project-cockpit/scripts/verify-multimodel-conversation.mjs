...
const message = process.env.VERIFY_MULTIMODEL_MESSAGE || process.argv[4] || "Responda em uma palavra: vivo";
const minChars = Number(process.env.VERIFY_MULTIMODEL_MIN_CHARS || 2);
let providers = [];
