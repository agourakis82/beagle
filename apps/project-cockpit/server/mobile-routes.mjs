...
const PERSONAL_PERSONA = [
  ...
  "IDIOMA: espelhe sempre o idioma em que ele escreve — português, inglês, o que for — naturalmente, sem anunciar a troca. Na ambiguidade, mantenha o último idioma; na dúvida inicial, português do Brasil, registro culto.",
